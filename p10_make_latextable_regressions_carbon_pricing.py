...
var2name = {\
			...
			'hdi': 'Education',
			'year_adoption': 'Year of adoption',
...
for TABLE_ID in ['01', '02', '03', '04', '05']:
	...
	if TABLE_ID == '01':
		EXPERIMENTS = [\
						'sequence_sample_none',
						'sequence_sample_all',
						'sequence_sample_handpicked',
						'sequence_sample_lasso1',
						'sequence_sample_noEU_none',
						'sequence_sample_noEU_handpicked',
						'pricelevel_sample_none',
						'pricelevel_sample_all',
						'pricelevel_sample_handpicked',
						'pricelevel_sample_lasso1',
						'pricelevel_sample_noEU_none',
						'pricelevel_sample_noEU_handpicked',
						]
		...
		EXPERIMENTS = [\
						'sequence_electricity_and_heat_production_sample_none',
						'sequence_transport_sample_none',
						'sequence_buildings_sample_none',
						'sequence_industry_sample_none',
						'pricelevel_electricity_and_heat_production_sample_none',
						'pricelevel_transport_sample_none',
						'pricelevel_buildings_sample_none',
						'pricelevel_industry_sample_none',
						]
		COLUMN_NAMES = [str(i+1) for i in range(np.size(EXPERIMENTS))]
		INDEX_COL_EST = 1
		INDEX_COL_SE = 2
		...
		EXPERIMENTS = [\
						'sequence_electricity_and_heat_production_sample_handpicked',
						'sequence_transport_sample_handpicked',
						'sequence_buildings_sample_handpicked',
						'sequence_industry_sample_handpicked',
						'pricelevel_electricity_and_heat_production_sample_handpicked',
						'pricelevel_transport_sample_handpicked',
						'pricelevel_buildings_sample_handpicked',
						'pricelevel_industry_sample_handpicked',
						]
		COLUMN_NAMES = [str(i+1) for i in range(np.size(EXPERIMENTS))]
		INDEX_COL_EST = 1
		INDEX_COL_SE = 2
		...
		EXPERIMENTS = [\
						'sequence_electricity_and_heat_production_sample_noEU_none',
						'sequence_transport_sample_noEU_none',
						'sequence_buildings_sample_noEU_none',
						'sequence_industry_sample_noEU_none',
						'pricelevel_electricity_and_heat_production_sample_noEU_none',
						'pricelevel_transport_sample_noEU_none',
						'pricelevel_buildings_sample_noEU_none',
						'pricelevel_industry_sample_noEU_none',
						]
		COLUMN_NAMES = [str(i+1) for i in range(np.size(EXPERIMENTS))]
		INDEX_COL_EST = 1
		INDEX_COL_SE = 2
		...
		EXPERIMENTS = [\
						'sequence_electricity_and_heat_production_sample_noEU_handpicked',
						'sequence_transport_sample_noEU_handpicked',
						'sequence_buildings_sample_noEU_handpicked',
						'sequence_industry_sample_noEU_handpicked',
						'pricelevel_electricity_and_heat_production_sample_noEU_handpicked',
						'pricelevel_transport_sample_noEU_handpicked',
						'pricelevel_buildings_sample_noEU_handpicked',
						'pricelevel_industry_sample_noEU_handpicked',
						]
		COLUMN_NAMES = [str(i+1) for i in range(np.size(EXPERIMENTS))]
		INDEX_COL_EST = 1
		INDEX_COL_SE = 2
	...
	for i, EXPERIMENT in enumerate(EXPERIMENTS):
		...
		df_new = df_new.append({'Variable': 'R2', COLUMN_NAME: '{0:3.2f}'.format(df['rsq'].values[0])}, ignore_index=True)
	...
	tablepath = './tables'
	tablefile = 'table_results_firstyear_{0:s}.tex'.format(TABLE_ID)
